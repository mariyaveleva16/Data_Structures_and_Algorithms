//https://www.hackerrank.com/contests/sda-homework-8/challenges/implement-nearest-neighbour
#include <bits/stdc++.h>
using namespace std;
...
long long distance_squared(const vector<int>& a,const vector<int>& b) {
    long long dist = 0;
